...
import com.scistor.estools.entity.QuartzJob;
import com.scistor.estools.mapper.QuartzJobMapper;
import com.scistor.estools.schedule.ExecutionJob;
...
public class QuartzJobService {
     ...
     * @param id /
     */
    public boolean execution(Long id){
        try {
...
//            throw new BadRequestException("定时任务暂停失败");
    ...
    public List<QuartzJob> querySchedule() {
        try {
